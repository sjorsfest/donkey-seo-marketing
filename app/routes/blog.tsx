...
const PAGE_TITLE = "Blog | Donkey SEO";
const PAGE_DESCRIPTION =
  "Guides, playbooks, and tactical insights for SEO teams shipping content with Donkey SEO.";
              ...
              {articles.map((article) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h2 className="font-display text-2xl font-bold mb-2 group-hover:text-yellow-700 transition-colors">
                      {article.title}
                    </h2>
                    {article.excerpt ? (

...
export function DashboardMockup() {
  ...
  return (
    <div className="w-full max-w-4xl">
      ...
      <div className="bg-white rounded-2xl border-4 border-outline shadow-[8px_8px_0_#1a1a1a] overflow-hidden">
        {/* Browser Top Bar */}
        <div className="bg-gray-200 px-4 py-3 border-b-4 border-outline flex items-center gap-2">
